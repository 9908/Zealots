...
function drawMessages()
	...
	for i, msg in ipairs(messages) do
		...
		love.graphics.rectangle("fill", 0, 0,love.graphics.getWidth(), 0.06*love.graphics.getHeight()+msg.opacity-msg.maxopacity)
		love.graphics.rectangle("fill", 0, 0.94*love.graphics.getHeight()-msg.opacity+msg.maxopacity,love.graphics.getWidth(), love.graphics.getHeight())

		myColor = {255, 255, 255,255}
		love.graphics.setColor(myColor)
		if msg.opacity > 0.9*msg.maxopacity then
		love.graphics.printf(msg.text, 0, 0.95	*love.graphics.getHeight(), love.graphics.getWidth(),"center")
		end
	end
end
