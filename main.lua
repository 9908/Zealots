...
function love.draw() 
	...
	elseif GAME_STATE ==  "START_MENU" then
		...
		useCustomFont(60)
		love.graphics.printf("Press any key to start",screenWidth/2-760+4,screenHeight/2+350+3,1500,'center')

		love.graphics.setColor(74,48,57)
		useCustomFont(200)
		love.graphics.printf("Zealots",screenWidth/2-500,screenHeight/2-400,1000,'center')
		useCustomFont(60)
		love.graphics.printf("Press any key to start",screenWidth/2-760,screenHeight/2+350,1500,'center')
	...
	elseif GAME_STATE ==  "LOSE" then
		...
		love.graphics.printf("Press any key to restart",offsetX+screenWidth/2-200+4,offsetY+screenHeight/2+50+3,500,'center')
		...
		love.graphics.printf("Press any key to restart",offsetX+screenWidth/2-200,offsetY+screenHeight/2+50,500,'center')
